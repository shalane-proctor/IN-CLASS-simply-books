  ...
  return (
    <Form onSubmit={handleSubmit}>
      ...
      <FloatingLabel controlId="floatingInput1" label="Last Name" className="mb-3">
        <Form.Control type="text" placeholder="Enter a title" name="last_name" value={formInput.last_name} onChange={handleChange} required />
      </FloatingLabel>
      <FloatingLabel controlId="floatingInput3" label="Email" className="mb-3">
        <Form.Control type="text" placeholder="Email" name="email" value={formInput.price} onChange={handleChange} required />
      </FloatingLabel>
      <Form.Check
